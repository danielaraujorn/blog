    ...
    */
    ...
    function pagination() {
        ...
        for (var i = current - limit; i < current; i++) {
            if (i > 0 && i !== 1) {
                link_html += '<a href="/blog/page' + i + '" class="page-link page-num">' + i + '</a>';
            } else if (i === 1) {
                link_html += '<a href="' +  '" class="page-link page-num">' + i + '</a>';
            }
        }
        ...
        for (var j = current + 1; j <= current + limit; j++) {
            if (j <= total) {
                link_html += '<a href="/blog/page' + j + '" class="page-link page-num">' + j + '</a>';
            }
        }
